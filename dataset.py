...
class DatasetFolder(data.Dataset):
    def __init__(self, root, label, extensions=['.jpg', '.png', '.jpeg', '.bmp'], transform=None, return_two_img=False,
                 big_imsize=128, scale_factor=4):
    ...
    def __getitem__(self, index):
        ...
        if self.return_two_img:
            ...
            sample_small = transforms.Resize(
                (self.big_imsize // self.scale_factor, self.big_imsize // self.scale_factor), Image.BICUBIC)(sample)
