...
def parse_args():
    ...
    parser.add_argument('--train_s_path', type=str, default='data/coal2D_train_LR_unknown_X4',
                        help='train source dataset path')
    parser.add_argument('--train_t_path', type=str, default='data/coal2D_train_HR',
                        help='train target dataset path')
    parser.add_argument('--test_s_path', type=str, default='data/shuffle_LR',
                        help='test source dataset path')
    parser.add_argument('--test_t_path', type=str, default='data/shuffle_HR',
                        help='test target dataset path')
    ...
    parser.add_argument('--phase', type=str, default='train_inner',
                        help='train_inner / train_outer / test_inner / test_outer')
    parser.add_argument('--scale_factor', type=int, default=4, help='scale factor : 2 / 4')
    parser.add_argument('--inner_ckpt_path', type=str, default='sr1/400000.pt',
                        help='Inner cycle checkpoint file path for fine tuning')
    parser.add_argument('--outer_ckpt_path', type=str, default='EDSR_x4.pt',
                        help='Outer cycle checkpoint file path for fine tuning')
    ...
    parser.add_argument('--fid_save_path', type=str, default='sr1/fid', help='Fid save path')
    parser.add_argument('--fid_s_path', type=str, default='data/sat_data/test/k3a/imgs', help='Fid source path')
    parser.add_argument('--fid_t_path', type=str, default='data/sat_data/test/wv3_cropped', help='Fid target path')
    ...
    parser.add_argument('--ckpt_save_path', type=str, default='sr1', help='ckpt save path')
